 ...
 * @type {object}
 * @property {number|null} expiration time in milliseconds since epoch, for the key-value pair
 * expiration=null
...
class AdobeState {
  ...
  async get (key) {
    ...
    if (response) {
      ...
      const expiration = Number(response.headers.get(HEADER_KEY_EXPIRES))
