...
class AdobeState {
  ...
  createRequestUrl (key, queryObject = {}) {
    ...
    if (key) {
      requestUrl = new url.URL(`${this.endpoint}/${API_VERSION}/containers/${this.namespace}/data/${key}`)
    } else {
      requestUrl = new url.URL(`${this.endpoint}/${API_VERSION}/containers/${this.namespace}`)
    }
